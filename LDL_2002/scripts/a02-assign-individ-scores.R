...
load(paste0("~/PRS/LDL_2002/scoring-files/final.scoring.file.chr", chr.i, ".RData"))
load(paste0("~/PRS/LDL_2002/dosages/final.dos.chr", chr.i))
...
save(samoa.scores, file=paste0("~/PRS/LDL_2002/prs-samoan-scores/samoa.prs.chr", chr.i, ".RData"))
