...
library(tidyverse)
  ...
  load(paste0("~/PRS/LDL/scoring-files/final.scoring.file.chr", chr.i, ".RData"))
  load(paste0("~/PRS/LDL/dosages/final.dos.chr", chr.i))
  ...
  save(samoa.scores, file=paste0("~/PRS/LDL/prs-samoan-scores/samoa.prs.chr", chr.i, ".RData"))
